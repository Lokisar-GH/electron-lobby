...
fs.access(`./version`, (err) => {
    if (err) {
        console.log('version file does not exist, downloading setup script')
      } else {
        console.log('launching busybox to check version mismatch, and download  setup script if needed')
      }
  })
